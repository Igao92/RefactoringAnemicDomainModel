...
using CreateCustomerDto = Api.Customers.CreateCustomerDto;
using CustomerDto = Api.Customers.CustomerDto;
using CustomerInListDto = Api.Customers.CustomerInListDto;
using MovieDto = Api.Customers.MovieDto;
using PurchasedMovieDto = Api.Customers.PurchasedMovieDto;
using UpateCustomerDto = Api.Customers.UpateCustomerDto;
